...
var displayMap = function displayMap(locations) {
   ...
   */
  mapboxgl.accessToken = 'pk.eyJ1IjoiYW1yaXRyZWdtaSIsImEiOiJja2oyNGcyajYyMzhvMnlxdHhsaGp6NGZ3In0.9N6A0EeG80pMiz3n2be47Q'; // telling mapbox guy to add map in div#map with provided style(just pass an option)
  ...
  var bounds = new mapboxgl.LngLatBounds(); // loop to the locations array and add a marker to that location 

  locations.forEach(function (location) {
    // 1 create a Marker with css by creating a new html element 
    var el = document.createElement('div');
    el.className = 'marker'; // 2. Creating a marker object and Adding it to the map
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(location.coordinates).setHTML("<p>Day ".concat(location.day, ": ").concat(location.description, " </p>")).addTo(map); // 3. make the boundary with given coordinates

    bounds.extend(location.coordinates);
  }); //4. Fit the bound(boundary) box into the map. with style options 

  var mapPaddingOption = {
    top: 200,
    bottom: 150,
    left: 100,
    right: 100
...
var showAlert = function showAlert(type, message) {
  var timeToShowAlert = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 15;
  hideAlert();
        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Logged in successfully'); // reload after 1.5 seconds
          ...
          case 7:
            ...
            (0, _alerts.showAlert)('error', 'Log in unsuccessful');
    ...
    return regeneratorRuntime.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            _context3.prev = 0;
            document.querySelector('.btn').textContent = 'Processing ...'; // ajax call 
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Welcome'); //reload after 1.5 second  and redirect to login Page
...
function () {
  var _ref2 = _asyncToGenerator(
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee2(passwordCurrent, password, passwordConfirm) {
    var res;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"sripe.js":[function(require,module,exports) {
"use strict";
...
var stripe = Stripe('pk_test_51I6EKyEmX29aiJaNxBIQEQHVasmAg6o3EKBsRIaLl9vElWd919twXf94XWIZlFP3TMMwTng3X5evzfrfoCmoFFmy00lNwjF4DK');
...
if (mapBox) {
  // if there is map section in DOM 
  // we have location data in id map in data-location 
...
if (logoutBtn) logoutBtn.addEventListener('click', _login.logout); // update name and email
...
if (userDataForm) {
  userDataForm.addEventListener('submit', function (e) {
    ...
    var form = new FormData(); // this object accepts multipart/form
